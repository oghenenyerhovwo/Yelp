...
export const createComment=(campgroundId, data) => (dispatch, getState) =>  {
    ...
    axios
      .post(`/api/campgrounds/${campgroundId}/comments`, data, setHeader(getState))
...
export const listComment=(campgroundId) => dispatch =>  {
    ...
    axios
      .get(`/api/campgrounds/${campgroundId}/comments`,)
...
export const deleteComment=(campgroundId, commentId) => (dispatch, getState) =>  {
  ...
  axios
    .delete(`/api/campgrounds/${campgroundId}/comments/${commentId}`, setHeader(getState))
